            ...
            <div className="p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-500">Density</p>
                  <p className="text-lg font-semibold text-gray-900">
                    {sample.density ? `${sample.density} g/ml` : '--'}
                  </p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-500">Roast Date</p>
                  <p className="text-lg font-semibold text-gray-900">
                    {sample.roastDate ? new Date(sample.roastDate).toLocaleDateString() : '--'}
                  </p>
                </div>
              </div>
            </div>
